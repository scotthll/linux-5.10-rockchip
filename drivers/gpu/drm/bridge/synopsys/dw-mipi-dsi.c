...
static int of_find_panel_or_bridge(const struct device_node *np,struct drm_panel **panel,
				struct drm_bridge **bridge)
{
				   ...
				   struct mipi_dsi_device *device)
{
	...
	ret  = of_find_panel_or_bridge(dsi->dev->of_node, &dsi->panel, &dsi->next_bridge);
